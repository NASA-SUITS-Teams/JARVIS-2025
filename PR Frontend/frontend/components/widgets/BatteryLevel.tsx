...
export default function BatteryLevel({
  ...
  // ——————————————————————————————
  // :one: Lazy‑initialize state once with all historical points
  ...
  // ——————————————————————————————
  // :two: On each new live reading, append one point
  useEffect(() => {
  ...
  // ——————————————————————————————
  // :three: Feed your rolling `data` directly into the chart
  return (
